...
export default function Nav() {
  ...
  return (
    <div className="w-full flex justify-between items-center mx-10 text-gray-700">
        <h2 id="title" className="text-3xl text-gray-700 font-bold">BUSAN <br/> <span className="text-2xl">지하철 실내공기정보</span></h2>
        <div className="flex justify-center items-center">
    
          {login &&
            <Link to="/subway" id="navcenter"
              className="inline-flex items-center justify-center text-lg font-bold text-gray-700
                mr-5 px-5 py-1 w-28 text-center hover:underline underline-offset-4">
              지하철
            </Link>}
